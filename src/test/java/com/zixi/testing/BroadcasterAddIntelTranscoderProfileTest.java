...
public class BroadcasterAddIntelTranscoderProfileTest extends BaseTest {
	...
	@Parameters({"userName", "userPass", "login_ip", "uiport", "mode", "profile_name",
			"enc", "bitrate", "gop", "fixed_gop", "closed_gop", "copy_gop",  "performance",
			"b_frames", "frame_type", "profile", "level", "bitrate_mode",
			"ref_frames", "hrd", "idr_int", "cavlc", "brightness", "contrast", "fps",
	...
	public void broadcasterSingleInputStreamstatisticAnilyzer(String userName, String userPass, String login_ip, String uiport,String mode, String profile_name,
			...
			String width, String height, String crf, String tune, String use_hw,  String max_bitrate, String testid)
		...
		Assert.assertEquals(
				((BroadcasterAddTranscoderProfileDriver) testDriver)
						.testIMPL(userName, userPass, login_ip, uiport, mode, profile_name,
								enc, bitrate, gop, fixed_gop, closed_gop, copy_gop, performance,
								b_frames, frame_type, profile, level, bitrate_mode,
								ref_frames, hrd, idr_int, cavlc, brightness, contrast, fps,
								width, height,crf, tune, use_hw, max_bitrate), "Profile added, existing transcoded streams may be restarted.");
	}
}
