...
public class BroadcasterUdpOutputCreationDriver extends BroadcasterLoggableApiWorker
	...
	String remux_bitrate, String df, String local_port, String dec_key, String type, String rows, String remux_buff, String local_ip,
	String remux_restampdts, String uiport, String remux_pcr,String dec_type, String cols) 
	{
		...
		"id:"+ id, "rtp:"+ rtp, "fec:"+ fec, "smoothing:"+ smoothing, "ttl:"+ ttl, "remux_bitrate:"+ remux_bitrate, "df:"+ df, "local_port:"+ local_port, 
		"dec_key:"+ dec_key, "type:"+ type, "rows:"+ rows, "remux_buff:"+ remux_buff, "local_ip:"+ local_ip,
		"remux_restampdts:"+ remux_restampdts, "uiport:"+ uiport, "remux_pcr:"+ remux_pcr,"dec_type:"+ dec_type, "cols:"+ cols);
		...
		return streamCreator.sendGet("http://" + loin_ip + ":" + uiport + "/zixi/add_output.json?" + rtype + "=" + type+
